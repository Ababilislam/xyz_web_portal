def new_web_order_entry():  
    ...
    save_order=request.vars.save_order
    order_dict = request.vars.orders_json
    # return order_dict
    # return "a"
    if save_order:
        "aa"
    ...
    item_query=f"""
    SELECT id, name,price,vat_amt,total_amt FROM SM_ITEM WHERE cid='{c_id}'
    """
...
def save_order():
    ...
    save_single_order=request.vars.save_single_order
