...
def order_details():
    ...
    return dict(rowid=rowid,visit_sl=visit_sl,records=record,sl=req_sl,client_name=client_name,status=status,order_date=order_date,level3_name=level3_name,payment_mode=payment_mode,note=note,mobile_no=mobile_no,page=page)
